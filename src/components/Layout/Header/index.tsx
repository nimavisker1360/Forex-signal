...
import Logoadvisor from "./Navigation/Logoadvisor";
  ...
  return (
    <header className=" bg-darkmode pt-5 shadow-none md:pt-10  ">
      <div className=" my-auto hidden md:flex flex-row lg:max-w-screen-xl mx-auto p-2 ">
        <div className="flex flex-row text-xs gap-3 flex-1 text-white">
          ...
          <div className="dropdown dropdown-hover dropdown-end">
            ...
            >
              <li className="rounded-lg flex flex-row">
                <span className="my-auto flex-1 flex"></span>
              </li>
            </ul>
          </div>
      ...
      <div className="lg:py-1 py-2">
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center justify-between px-4">
          ...
          <nav className="hidden overflow lg:flex flex-grow items-center gap-x-12 ">
            <Logoadvisor />
          </nav>
          <hr className=" mx-auto lg:max-w-screen-xl " />
